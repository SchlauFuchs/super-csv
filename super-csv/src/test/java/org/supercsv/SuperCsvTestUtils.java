...
public class SuperCsvTestUtils {
	...
	public static final String[] HEADER = new String[] { "customerNo", "firstName", "lastName", "birthDate",
		"birthTime", "mailingAddress", "married", "numberOfKids", "favouriteQuote", "email", "loyaltyPoints" };
	public static final String HEADER_CSV = "customerNo,firstName,lastName,birthDate,birthTime,mailingAddress,married,"
	...
	public static final CellProcessor[] READ_PROCESSORS = new CellProcessor[] { null, null, null,
		new ParseDate("dd/MM/yyyy"), new ParseSqlTime("HH:mm:ss"), null, new Optional(new ParseBool()),
		new Optional(new ParseInt()), null, null, new ParseLong() };
	...
	public static final CellProcessor[] WRITE_PROCESSORS = new CellProcessor[] { null, null, null,
		new FmtDate("dd/MM/yyyy"), new FmtSqlTime("HH:mm:ss"), null, new Optional(new FmtBool("Y", "N")), null, null, null,
		null };
		
	// each line in the CSV file and it's corresponding CustomerBean/CustomerStringBeans for testing
	public static final String JOHN_CSV = "1,John,Dunbar,13/06/1945,10:20:00,\"1600 Amphitheatre Parkway\r\nMountain View, CA 94043\r\nUnited States\","
		+ ",,\"\"\"May the Force be with you.\"\" - Star Wars\",jdunbar@gmail.com,0";
	public static final CustomerBean JOHN = new CustomerBean("1", "John", "Dunbar", date(1945, 6, 13), time(10, 20, 0),
	...
	public static final String BOB_CSV = "2,Bob,Down,25/02/1919,10:20:00,\"1601 Willow Rd.\r\nMenlo Park, CA 94025\r\nUnited States\","
		+ "Y,0,\"\"\"Frankly, my dear, I don't give a damn.\"\" - Gone With The Wind\",bobdown@hotmail.com,123456";
	public static final CustomerBean BOB = new CustomerBean("2", "Bob", "Down", date(1919, 2, 25), time(10, 20, 0),
	...
	public static final String ALICE_CSV = "3,Alice,Wunderland,08/08/1985,12:20:00,\"One Microsoft Way\r\nRedmond, WA 98052-6399\r\nUnited States\","
	...
	public static final CustomerBean ALICE = new CustomerBean("3", "Alice", "Wunderland", date(1985, 8, 8),
		time(12, 20, 0), "One Microsoft Way\nRedmond, WA 98052-6399\nUnited States", true, 0,
	...
	public static final String BILL_CSV = "4,Bill,Jobs,10/07/1973,10:28:00,\"2701 San Tomas Expressway\r\nSanta Clara, CA 95050\r\nUnited States\","
		+ "Y,3,\"\"\"You've got to ask yourself one question: \"\"Do I feel lucky?\"\" Well, do ya, punk?\"\" - Dirty Harry\",billy34@hotmail.com,36";
	public static final CustomerBean BILL = new CustomerBean("4", "Bill", "Jobs", date(1973, 7, 10), time(10, 28, 0),
	...
	public static final String MIRANDA_CSV = "5,Miranda,Feist,03/01/1999,11:24:00,\"2-4 Rue du Sablon\r\nMorges, 1110\r\nSwitzerland\","
	...
	public static final CustomerBean MIRANDA = new CustomerBean("5", "Miranda", "Feist", date(1999, 1, 3),
		time(11, 24, 0), "2-4 Rue du Sablon\nMorges, 1110\nSwitzerland", null, null,
		"\"You had me at \"hello.\"\" - Jerry Maguire", "miranda_feist@gmail.com", 54623L);
	public static final CustomerStringBean MIRANDA_STRING = new CustomerStringBean(MIRANDA);
	
	public static final String STEVE_CSV = "6,Steve,Gates,31/12/2000,20:40:00,\"701 First Avenue\r\nSunnyvale, CA 94089\r\nUnited States\","
	...
	public static final String ADA_CSV = "7,Ada,Von Trappe,18/11/1956,23:10:00,\"One Dell Way\r\nRound Rock, TX 78682\r\nUnited States\","
	...
	public static final String SERGEI_CSV = "8,Sergei,Denisovich,22/06/1944,05:35:00,\"1 Infinite Loop\r\nCupertino, CA 95014\r\nUnited States\","
	...
	public static final String LARRY_CSV = "9,Larry,Ballmer,01/01/1901,02:00:00,\"1-7-1 Konan\r\nMinato-ku\r\nTokyo, 108-0075\r\nJapan\","
		+ "N,0,\"\"\"A martini. Shaken, not stirred.\"\" - Goldfinger\",lazza99@gmail.com,164";
	public static final CustomerBean LARRY = new CustomerBean("9", "Larry", "Ballmer", date(1901, 1, 1), time(2, 0, 0),
	...
	public static final String GRACE_CSV = "10,Grace,Fowler,28/11/2003,21:19:00,\"11-1, Kamitoba Hokotate-cho\r\nMinami-ku\r\nKyoto, 601-8501\r\nJapan\","
	...
	public static final CustomerBean GRACE = new CustomerBean("10", "Grace", "Fowler", date(2003, 11, 28),
		time(21, 19, 0), "11-1, Kamitoba Hokotate-cho\nMinami-ku\nKyoto, 601-8501\nJapan", false, 0,
	...
	public static final List<CustomerStringBean> STRING_CUSTOMERS = Arrays.asList(JOHN_STRING, BOB_STRING, ALICE_STRING,
		BILL_STRING, MIRANDA_STRING, STEVE_STRING, ADA_STRING, SERGEI_STRING, LARRY_STRING, GRACE_STRING);
	...
	/**
	 * An easy and non-deprecated non-lenient way of creating Time objects.
	 * 
	 * @param hour
	 *            the hour in 24 hour format where 0 == midnight
	 * @param minute
	 ...
	 */
	public static Time time(final int hour, final int minute, final int second) {
