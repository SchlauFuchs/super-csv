...
public class ParseIntTest {
	...
	public void testValidInts() {
		// positive values
		assertEquals(POSITIVE_VAL, (int) processor.execute(POSITIVE_VAL, ANONYMOUS_CSVCONTEXT));
		assertEquals(POSITIVE_VAL, (int) processorChain.execute(POSITIVE_VAL, ANONYMOUS_CSVCONTEXT));
		
		// negative values
		assertEquals(NEGATIVE_VAL, (int) processor.execute(NEGATIVE_VAL, ANONYMOUS_CSVCONTEXT));
		assertEquals(NEGATIVE_VAL, (int) processorChain.execute(NEGATIVE_VAL, ANONYMOUS_CSVCONTEXT));
	}
	...
	public void testValidIntStrings() {
		// positive values
		assertEquals(POSITIVE_VAL, (int) processor.execute(POSITIVE_STRING, ANONYMOUS_CSVCONTEXT));
		assertEquals(POSITIVE_VAL, (int) processorChain.execute(POSITIVE_STRING, ANONYMOUS_CSVCONTEXT));
		
		// negative values
		assertEquals(NEGATIVE_VAL, (int) processor.execute(NEGATIVE_STRING, ANONYMOUS_CSVCONTEXT));
		assertEquals(NEGATIVE_VAL, (int) processorChain.execute(NEGATIVE_STRING, ANONYMOUS_CSVCONTEXT));
	}
