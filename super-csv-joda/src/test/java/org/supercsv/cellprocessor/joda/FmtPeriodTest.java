...
public class FmtPeriodTest {
	...
	public void setUp() {
		...
		FmtPeriod processor1 = new FmtPeriod();
		FmtPeriod processor2 = new FmtPeriod(formatter);
		FmtPeriod processorChain1 = new FmtPeriod(new IdentityTransform());
		FmtPeriod processorChain2 = new FmtPeriod(formatter, new IdentityTransform());
	...
	public void testConstructor4WithNullFormatter() {
		new FmtPeriod(null, new IdentityTransform());
	}
